...
JobdfTrain %>% ggplot() + geom_bar(aes(x = BusinessTravel, fill = JobRole), position = "fill", alpha = 0.9) + coord_flip()

JobdfTrain %>% ggplot() + geom_bar(aes(x = EnvironmentSatisfaction, fill = JobRole), position = "fill", alpha = 0.9) + coord_flip()
...
JobdfTrain %>% ggplot() + geom_bar(aes(x = JobInvolvement, fill = JobRole), position = "fill", alpha = 0.9) + coord_flip()

JobdfTrain %>% ggplot() + geom_bar(aes(x = OverTime, fill = JobRole), position = "fill", alpha = 0.9) + coord_flip()

JobdfTrain %>% ggplot() + geom_bar(aes(x = PerformanceRating, fill = JobRole), position = "fill", alpha = 0.9) + coord_flip()
